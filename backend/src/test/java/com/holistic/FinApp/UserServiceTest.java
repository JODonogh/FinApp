...
class UserServiceTest {
    ...
    void testFindUserById_WhenUserExists() {
        ...
        User mockUser = new User(12122L, "John Doe", "john.doe@example.com", "password");
    ...
    void testCreateUser() {
        // Given a new user
        User newUser = new User(null, "Jane Doe", "jane.doe@example.com", "password");
